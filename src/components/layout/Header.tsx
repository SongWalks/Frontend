...
export default function Header({ leftNode, title, rightNode }: HeaderProps) {
  return (
    ...
    <header className="relative flex justify-between items-center w-full h-[56px] px-4 bg-white border-b border-gray-200 z-50">
      ...
      {title && (
        <div className="absolute inset-x-0 flex justify-center items-center pointer-events-none">
          ...
          <span className="text-[17px] font-bold text-gray-900 pointer-events-auto">
            {title}
          </span>
        </div>
      )}
