  ...
  return (
    ...
    <div className="flex flex-col h-screen w-full bg-white relative">
      ...
      <main className="flex-1 flex flex-col items-center px-5 pt-[60px] pb-8 overflow-y-auto">
        {/* 완료 체크 아이콘 */}
        <div className="w-[72px] h-[72px] rounded-full border border-[#3BA5FF] flex justify-center items-center mb-6">
          <Icon icon="ph:check-bold" className="text-[40px] text-[#3BA5FF]" />
        </div>
        ...
        <p className="text-[14px] text-gray-500 text-center leading-relaxed mb-10">
          관리자 확인 후 처리합니다.
          <br />
        ...
        {/* 정책 안내 박스 */}
        <div className="w-full bg-[#F5F5F5] rounded-xl p-6 flex flex-col gap-8">
          {/* 신고 처리 정책 */}
          <div>
            <h3 className="text-[15px] font-bold text-gray-600 mb-3">
              신고 처리 정책
            </h3>
